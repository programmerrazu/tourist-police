...
import com.tourist.police.viewModel.ComplainViewModel;
...
public class ComplainFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(ComplainViewModel.class);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        acTvHeaderTitle.setText(R.string.txt_complain);
        Picasso.get().load(R.drawable.complain).into(acIvHeaderIcon);
    }
